  ...
  gtag('config', 'G-77VVQVBH64');
    ...
    <style>
        * {
        ...
        .ai-build-service-inner {
            max-width: 1200px;
            margin: 0 auto;
        }

        .ai-build-service .service-label {
            display: block;
            margin-bottom: 10px;
            color: #91d7f4;
            font-size: 12px;
        ...
        .ai-build-service .service-intro {
            max-width: 820px;
            margin: 0 0 34px;
            color: #c5d8e6;
            font-size: 18px;
        ...
        .ai-service-step span,
        .ai-service-step strong {
            display: block;
        }
        ...
        .ai-service-actions a:last-child {
            color: #dceaf4;
            font-weight: 600;
            text-decoration: none;
        }
...
<body>
    ...
    <section class="ai-build-service" aria-labelledby="ai-build-service-title">
        <div class="ai-build-service-inner">
            <span class="service-label">AI APPLICATION &amp; AUTOMATION DEVELOPMENT</span>
            <h2 id="ai-build-service-title">Start with one workflow your team wants to make easier.</h2>
            <p class="service-intro">PE Tech Partners turns repetitive, document-heavy, and disconnected work into practical applications your team can test before committing to a larger build.</p>
            <div class="ai-service-steps">
                <article class="ai-service-step"><span>01 · DISCOVER</span><strong>Identify the bottleneck</strong><p>Choose the work consuming time, hiding risk, or delaying the next decision.</p></article>
                <article class="ai-service-step"><span>02 · PROVE</span><strong>See a working example</strong><p>Use safe sample data to demonstrate the new workflow and the result your team would receive.</p></article>
                <article class="ai-service-step"><span>03 · PUT IT TO WORK</span><strong>Build around your business</strong><p>Connect the approved application to your systems, rules, permissions, and human review steps.</p></article>
            </div>
            <div class="ai-service-actions">
                <a href="ai-solutions-lab.php" class="btn btn-primary">Explore the AI Solutions Lab</a>
                <a href="process.php">See how an engagement works →</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="cta-grid">
                <div class="animate-on-scroll scale-in">
                    <img class="cta-image" src="attached_assets/image_1761591065504.png" alt="Team collaboration" loading="lazy" width="1024" height="1024">
                </div>
                <div>
